...
public class LInvertida extends Tetrimino {
	...
	public LInvertida(Grilla mg) {
	    ...
	    pos2=mg.getBloque(1,5);
	    pos3=mg.getBloque(0,5);
	    poscentral=mg.getBloque(1,4);
	    
	    String rutaLInvertida_0="/images/LInvertida_Tetrimino_0.png";
	    String rutaLInvertida_90="/images/LInvertida_Tetrimino_90.png";
	    String rutaLInvertida_180="/images/LInvertida_Tetrimino_180.png";
	    String rutaLInvertida_270="/images/LInvertida_Tetrimino_270.png";
	...
	public boolean moverAbajo() {
		boolean bajarposible_0_90 = ((rotacion == 0) || (rotacion == 90)) && (pos1.getFila() != (miGrilla.getFilas()-1));
		boolean bajarposible_180_270 = ((rotacion == 180) || (rotacion == 270)) && (pos3.getFila() != (miGrilla.getFilas()-1));
		...
		if(movimientoPosible) {		
			...
			switch(rotacion) {
				...
				case(90): {
					movimientoPosible = ( newP1.estaLibre() && newP3.estaLibre() );
					if(movimientoPosible) {
						ocuparDesocuparCuatroBloquesEnOrden(newP1, pos1, newPosCentral, poscentral, newP3, pos3, newP2, pos2);
					}
					break;
				}
				case(180): {
					movimientoPosible = ( newP3.estaLibre() && newPosCentral.estaLibre() && newP1.estaLibre() );
					if(movimientoPosible) {
				...
				case(270): {
					...
					if(movimientoPosible) {
						ocuparDesocuparCuatroBloquesEnOrden( newP2, pos2, newP3, pos3, newPosCentral, poscentral, newP1, pos1);
					} 
					break;
				}
			}
	...
	public void moverIzquierda() {
		boolean movizqposible_0_270 = ((rotacion == 0) || (rotacion == 270)) && (pos1.getColumna() != 0);
		boolean movizqposible_90_180 = ((rotacion == 90) || (rotacion == 180)) && (pos3.getColumna() != 0);
		
		if(movizqposible_0_270 || movizqposible_90_180) {
			...
			switch(rotacion) {
				case(0): {
					mover = newP1.estaLibre() && newP3.estaLibre();
					if(mover) {
				...
				case(90): {
					mover = newP3.estaLibre() && newPosCentral.estaLibre() && newP1.estaLibre();
					if(mover) { 
						ocuparDesocuparCuatroBloquesEnOrden(newP3, pos3, newP2, pos2, newPosCentral, poscentral, newP1, pos1);
					} 
					break;
				...
				case(270): {
					mover = newP1.estaLibre() && newPosCentral.estaLibre() && newP2.estaLibre();
					if(mover) { 
						ocuparDesocuparCuatroBloquesEnOrden(newP1, pos1, newPosCentral, poscentral, newP2, pos2, newP3, pos3);
					} 
					break;
	...
	public void moverDerecha() {
		boolean movderposible_0_270 = ((rotacion == 0) || (rotacion == 270)) && (pos3.getColumna() != (miGrilla.getColumnas()-1));
		boolean movderposible_90_180 = ((rotacion == 90) || (rotacion == 180)) && (pos1.getColumna() != (miGrilla.getColumnas()-1));
		
		if(movderposible_0_270 || movderposible_90_180) {
			Bloque newP1 = miGrilla.getBloque(pos1.getFila(), pos1.getColumna()+1);
			Bloque newP2 = miGrilla.getBloque(pos2.getFila(), pos2.getColumna()+1);
			Bloque newP3 = miGrilla.getBloque(pos3.getFila(), pos3.getColumna()+1);
			Bloque newPosCentral = miGrilla.getBloque(poscentral.getFila(), poscentral.getColumna()+1);
			...
			switch(rotacion) {
				...
				case(90): {
					mover = newP2.estaLibre() && newPosCentral.estaLibre()  && newP1.estaLibre();
					if(mover) {
						ocuparDesocuparCuatroBloquesEnOrden(newP1, pos1, newPosCentral, poscentral, newP2, pos2, newP3, pos3);
					} 
					break;
	...
	public Integer[] filasOcupadas() {
		...
		switch(rotacion) {
			...
			case(90): {
				...
				filas[2] = pos1.getFila();
				break;
			}
			case(180): {
				filas[0] = pos2.getFila();
				filas[1] = pos3.getFila();
				break;
			}
			case(270): {
